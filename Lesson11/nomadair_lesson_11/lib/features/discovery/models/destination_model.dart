final class DiscoveryDestination {
  const DiscoveryDestination({
    required this.id,required this.city,required this.country,
    required this.iataCode,required this.tagline,required this.priceFromInr,
    required this.category,required this.skyColorTop,required this.skyColorBottom,
    this.trendingRank,this.isMatchingSearch=false,
  });
  final String id,city,country,iataCode,tagline,category;
  final double priceFromInr;
  final int    skyColorTop,skyColorBottom;
  ...
  static const List<DiscoveryDestination> samples = [
    ...
    DiscoveryDestination(id:'cdg',city:'Paris',country:'France',iataCode:'CDG',
      tagline:'La ville lumière',priceFromInr:48000,category:'flights',
