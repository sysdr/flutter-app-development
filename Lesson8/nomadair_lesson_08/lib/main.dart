...
import 'features/inclusive_audit/screens/inclusive_audit_screen.dart';
...
final class NomadAirApp extends StatefulWidget {
  const NomadAirApp({
    super.key, required this.svc, required this.initialMode,
  });
