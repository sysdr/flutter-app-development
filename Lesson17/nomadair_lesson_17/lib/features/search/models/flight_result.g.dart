...
FlightResult _$FlightResultFromJson(Map<String, dynamic> json) =>
    FlightResult(
      ...
      cabinClass:       _$cabinFromJson(json['cabin_class']   as String),
      seatsLeft:        json['seats_left']        as int,
      baggageAllowance: json['baggage_allowance'] as String,
      isRefundable:     json['is_refundable']     as bool,
    );

Map<String, dynamic> _$FlightResultToJson(FlightResult i) => {
  'id':               i.id,
  'airline':          i.airline,
  'airline_code':     i.airlineCode,
  'flight_number':    i.flightNumber,
  'origin':           i.origin,
  'destination':      i.destination,
  'departure_time':   i.departureTime.toIso8601String(),
  'arrival_time':     i.arrivalTime.toIso8601String(),
  'duration_minutes': i.durationMinutes,
  'price_inr':        i.priceInr,
  'stops':            i.stops,
  'cabin_class':      _$cabinToJson(i.cabinClass),
  'seats_left':       i.seatsLeft,
  'baggage_allowance': i.baggageAllowance,
  'is_refundable':    i.isRefundable,
};

CabinClass _$cabinFromJson(String s) => switch (s) {
  'economy'        => CabinClass.economy,
  'premiumEconomy' => CabinClass.premiumEconomy,
  'business'       => CabinClass.business,
  'firstClass'     => CabinClass.firstClass,
  _ => throw ArgumentError('Unknown cabin: $s'),
};
String _$cabinToJson(CabinClass c) => switch (c) {
