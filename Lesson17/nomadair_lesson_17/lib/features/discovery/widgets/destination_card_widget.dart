...
final class DestinationCardWidget extends StatelessWidget{
  ...
  @override Widget build(BuildContext context){
    ...
    return Semantics(label:destination.accessibilityLabel,button:onTap!=null,
      child:Card(clipBehavior:Clip.antiAlias,shape:RoundedRectangleBorder(
...
class _P extends CustomPainter{
  ...
  @override void paint(Canvas c,Size s){final r=Offset.zero&s;
