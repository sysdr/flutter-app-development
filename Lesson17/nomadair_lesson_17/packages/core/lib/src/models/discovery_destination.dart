/// Discovery destination model shared by `nomadair_ui` and the app.
final class DiscoveryDestination {
  ...
  String get formattedPrice =>
      'from ₹${priceFromInr.toStringAsFixed(0)}';
  ...
  static const List<DiscoveryDestination> samples = [
    ...
    DiscoveryDestination(
      ...
      priceFromInr: 22000,
      category: 'both',
      skyColorTop: 0xFF00695C,
      skyColorBottom: 0xFF1B5E20,
      trendingRank: 2,
    ),
    DiscoveryDestination(
      id: 'nrt',
      ...
      country: 'Japan',
      iataCode: 'NRT',
      tagline: 'Neon and tradition',
      priceFromInr: 38000,
      category: 'both',
      skyColorTop: 0xFF880E4F,
    ...
    DiscoveryDestination(
      ...
      priceFromInr: 48000,
      category: 'flights',
      skyColorTop: 0xFF283593,
      skyColorBottom: 0xFF1A237E,
    ),
    DiscoveryDestination(
      id: 'lhr',
      city: 'London',
      country: 'UK',
      iataCode: 'LHR',
      tagline: 'History meets future',
      priceFromInr: 42000,
      category: 'flights',
      skyColorTop: 0xFF1565C0,
      skyColorBottom: 0xFF546E7A,
    ),
  ];
}
