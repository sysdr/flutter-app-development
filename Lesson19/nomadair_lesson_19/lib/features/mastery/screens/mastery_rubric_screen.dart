...
/// Lesson 19 — MasteryRubricScreen.
///
/// Interactive checklist for Modules 2 (L18 assertions) and
/// Module 3 L1 (DOMAIN assertions). 36 total.
...
final class _MasteryRubricScreenState
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        title: const Text('Mastery Rubric — L19'),
