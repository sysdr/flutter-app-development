...
/// Destination card for the Discovery feed.
///
/// **Widget** — no routes, no providers, constructor-only.
/// Uses [ColorFilter] with [NomadThemeExtension.imageOverlayColor]
/// for dark-mode tinting (Lesson 07 pattern).
                          ...
                          if (destination.isTrending)
                            Container(
                              ...
                              decoration: BoxDecoration(
                                color: t.brandAccent.withAlpha(28),
                                borderRadius: BorderRadius.circular(
                                  AppSpacing.radiusFull),
                                border: Border.all(
                                  color: t.brandAccent.withAlpha(100))),
                              child: Text('#${destination.trendingRank}',
...
class _GradPainter extends CustomPainter {
  const _GradPainter({required this.top,required this.bottom,required this.iata});
