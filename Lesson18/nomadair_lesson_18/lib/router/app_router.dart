          ...
          StatefulShellBranch(routes: [
            GoRoute(
              ...
              routes: [GoRoute(path: 'detail',
                builder: (_, state) {
                  final e = state.extra;
                  if (e is DiscoveryDestination) {
                    return DestinationDetailScreen(destination: e);
                  }
            ...
            GoRoute(
              ...
              routes: [
                GoRoute(
                  ...
                  routes: [
                    // L18: flight detail via GoRouter extra
                    GoRoute(
                      path: 'detail',
                      builder: (_, state) {
                        final f = state.extra;
                        ...
                        return const NotFoundScreen(
                          location: 'FlightDetail: missing FlightResult extra');
                      }),
                  ]),
              ]),
          ]),
