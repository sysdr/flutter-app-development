...
/// Lesson 20 â€” Hive initialised before runApp.
///
/// Order matters:
///   1. Hive.initFlutter()          â€” sets up the app-documents path
///   2. Hive.registerAdapter(...)   â€” must happen before openBox
///   3. HiveStorageService.init()   â€” opens the Hive boxes
///   4. runApp(...)                 â€” UI starts
void main() async {
  WidgetsFlutterBinding.ensureInitialized();

  // â”€â”€ Hive setup â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  ...
  // â”€â”€ Theme pref â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
  ...
  runApp(
    MultiProvider(
      providers: [
        // Storage â€” screens read/write via LocalStorageService
