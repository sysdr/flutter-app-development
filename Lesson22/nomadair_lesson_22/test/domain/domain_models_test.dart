...
import 'package:nomadair_lesson_22/core/domain/flight.dart';
import 'package:nomadair_lesson_22/core/domain/hotel.dart';
import 'package:nomadair_lesson_22/core/domain/passenger.dart';
import 'package:nomadair_lesson_22/core/domain/price_breakdown.dart';
import 'package:nomadair_lesson_22/core/domain/itinerary.dart';
import 'package:nomadair_lesson_22/core/domain/booking_state.dart';
import 'package:nomadair_lesson_22/core/domain/travel_class.dart';
import 'package:nomadair_lesson_22/core/domain_converters.dart';
import 'package:nomadair_lesson_22/features/search/models/search_criteria.dart';
import 'package:nomadair_lesson_22/features/search/models/selected_city.dart';
import 'package:nomadair_lesson_22/features/search/repositories/mock_flight_repository.dart';
import 'package:nomadair_lesson_22/features/search/repositories/mock_hotel_repository.dart';
...
// FLIGHT â€” 12 assertions
// â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•

void _flightTests() {
  group('Flight â€” copyWith', () {
  ...
  group('Flight â€” computed getters', () {
  ...
  group('Flight â€” fromFlightResult', () {
...
// â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
// PRICE BREAKDOWN â€” 8 assertions
// â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
...
// â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
// BOOKING STATE â€” when/maybeWhen â€” 6 assertions
// â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
...
void _bookingStateTests() {
  group('BookingState.when', () {
    ...
    test('loading dispatches with message', () {
      const state = BookingState.loading(message: 'Processing paymentâ€¦');
      ...
      expect(msg, 'Processing paymentâ€¦');
    });
...
void main() {
  ...
  _bookingStateTests(); // 6 assertions  â”€â”€ total: 42
}
