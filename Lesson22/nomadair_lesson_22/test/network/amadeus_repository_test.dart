...
import 'package:nomadair_lesson_22/core/network/amadeus_token_service.dart';
import 'package:nomadair_lesson_22/core/network/network_exception.dart';
...
import 'package:nomadair_lesson_22/features/search/repositories/amadeus_flight_repository.dart';
...
void main() {
  group('AmadeusFlightRepository', () {
    ...
    test('empty data list â†’ empty result', () async {
      final repo = _repo(MockClient(
          (_) async => _offersResp([])));
