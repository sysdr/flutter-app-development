...
final class NomadTextField extends StatelessWidget{
  const NomadTextField({super.key,required this.label,this.hint,this.error,
        ...
        child:TextField(
          ...
          decoration:InputDecoration(
            ...
            prefixIcon:prefixIcon!=null
              ?ExcludeSemantics(child:Icon(prefixIcon,size:20,
                color:t.onSurfaceColor.withAlpha(160))):null,
            suffixIcon:suffixIcon!=null
              ?Semantics(label:'Toggle',button:true,
                child:IconButton(icon:Icon(suffixIcon,size:20),onPressed:onSuffixTap)):null,
