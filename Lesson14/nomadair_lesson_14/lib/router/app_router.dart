              ...
              routes: [GoRoute(path: 'detail',
                builder: (_, state) {
                  ...
                  final dest = DiscoveryDestination.samples
                      ...
                      .firstOrNull;
                  return dest == null
                      ? NotFoundScreen(location: 'Destination $iata not found')
          ...
          StatefulShellBranch(routes: [
            GoRoute(
              ...
              builder: (_, state) {
                ...
                return SearchScreen(
                  initialOrigin: from, initialDestination: to);
              },
              routes: [GoRoute(path: 'results',
                builder: (_, state) => SearchResultsScreen(
                  criteria: state.extra is SearchCriteria
                      ? state.extra as SearchCriteria : null))],
            ),
          ]),
          StatefulShellBranch(routes: [
            GoRoute(path: NavigatorRoutes.trips,
