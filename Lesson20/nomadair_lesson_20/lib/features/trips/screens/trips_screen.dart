  ...
  Widget build(BuildContext context) {
    ...
    return ListView(
      ...
      children: [
        Text(
          'My Trips',
          style: AppTypography.displayLarge.copyWith(color: theme.onSurfaceColor),
        ),
            ...
            children: [
              ExcludeSemantics(
                child: Icon(
                  ...
                  size: 64,
                  color: theme.onSurfaceColor.withAlpha(80),
                ),
              ),
              const SizedBox(height: AppSpacing.md),
              Text(
                'No trips yet',
                style: AppTypography.headlineMedium.copyWith(color: theme.onSurfaceColor),
              ),
