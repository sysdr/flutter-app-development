...
abstract final class NomadAirTheme {
  static ThemeData light() =>
      _b(Brightness.light, NomadThemeExtension.light, AppColors.grey50);
  static ThemeData dark() =>
      _b(Brightness.dark, NomadThemeExtension.dark, AppColors.darkBackground);

  static ThemeData _b(Brightness b, NomadThemeExtension ext, Color sc) =>
      ThemeData(
        useMaterial3: true,
